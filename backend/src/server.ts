...
const avatarManger = new UserAvatarManager(
  process.env.AVATAR_DIRECTORY,
  process.env.DEFAULT_AVATAR_IMAGE
);
...
const getDynamicContext = async (req: express.Request): Promise<Context> => {
